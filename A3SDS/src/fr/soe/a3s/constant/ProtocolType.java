...
public enum ProtocolType
{
  ...
  public static ProtocolType getEnum(String description) {
    if (description.equals(FTP.getDescription()))
      return FTP;
    if (description.equals(HTTP.getDescription()))
      return HTTP;
    if (description.equals(HTTPS.getDescription()))
      return HTTPS;
    if (description.equals(HTTP_WEBDAV.getDescription()))
      return HTTP_WEBDAV;
    if (description.equals(HTTPS_WEBDAV.getDescription())) {
      return HTTPS_WEBDAV;
    }
    return null;
  }
